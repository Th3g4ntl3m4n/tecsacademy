...
@section('content')
      ...
      <p class="text-white-50 lead measure-hero-lead mx-auto">Change your future today with over 1.000 professional courses from the top industry leading teachers and professionals.</p>
                        ...
                        <div class="row card-group-row mb-16pt mb-lg-40pt justify-content-center">
                                ...
                                <div class="card card-group-row__card text-center o-hidden card--raised border-0">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="d-flex justify-content-center align-items-center m-0">
                                            ...
                                            <span class="h1 m-0 font-weight-normal">160.000</span>
                                            <span class="h4 m-0 font-weight-normal">/COP</span>
                                        </p>
                                        <p class="lh-1 text-muted mb-0"><small>after the free trial ends</small></p>
                                    </div>
                                    <div class="card-footer">
                                        <a href="{{ route('paydetails')}}"
                                           class="btn btn-accent">Siguiente Paso</a>
                                    </div>
                                </div>
                            </div>
