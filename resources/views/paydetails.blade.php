                        ...
                        <div class="row">
                            <div class="col-md-6 mb-24pt mb-md-0">
                                <form action="{{ route('payment')}}">
                                    ...
                                    <button class="btn btn-danger">Siguiente Paso</button>
                                </form>
                            </div>
                            <div class="col-md-6">
                                <div class="card mb-0">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-16pt pb-16pt border-bottom">
                                            <div class="flex"><strong class="text-70">Precio</strong></div>
                                            <strong>US &dollar;160.000 COP</strong>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox"
                                                   ...
                                                   checked
                                                   id="topic-all">
                                            <a href="{{ route('termsAndConditions')}}"><label class="custom-control-label">Terms and conditions</label></a>
